...
Commit the resulting `.rds` files in `_snaps/<context>/reference_plotobject/` alongside the SVG snapshots. On the next GitHub run, failing SVG comparisons will fall back to comparing against these `.rds` files.
